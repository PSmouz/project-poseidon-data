...
# from src.poseidonscraper.poseidonscraper.items import LoungeItem
...
class LoungeSpider(scrapy.Spider):
    ...
    def __init__(self, categories=None, *args, **kwargs):
        ...
        self.start_urls = [
            f"https://us.lounge.com/collections/{category_paths[cat]}"
    ...
    def parse_item(self, response):
        content = response.xpath(
            '//script[contains(@type, "application/json") and contains(@data-json, "product-page")]/text()'
        ).get()
