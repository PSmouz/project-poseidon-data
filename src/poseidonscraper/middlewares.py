...
class PoseidonscraperSpiderMiddleware:
...
class PoseidonscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class FakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        request.headers["accept-language"] = random_browser_header[
            "accept-language"
        ]  #'de-DE' #
        request.headers["sec-fetch-user"] = random_browser_header[
            "sec-fetch-user"
        ]
        request.headers["sec-fetch-mod"] = random_browser_header[
            "sec-fetch-mod"
        ]
        request.headers["sec-fetch-site"] = random_browser_header[
            "sec-fetch-site"
        ]
        request.headers["sec-ch-ua-platform"] = random_browser_header[
            "sec-ch-ua-platform"
        ]
        request.headers["sec-ch-ua-mobile"] = random_browser_header[
            "sec-ch-ua-mobile"
        ]
